...
(() => {
  ...
  const modeForEntry = (entry,dayIndex) => entry?.hinhThucDay || (typeof teachingModeFromDateV704649==='function' ? teachingModeFromDateV704649([dateAt(current.context.mondayOfWeek,dayIndex).getFullYear(),String(dateAt(current.context.mondayOfWeek,dayIndex).getMonth()+1).padStart(2,'0'),String(dateAt(current.context.mondayOfWeek,dayIndex).getDate()).padStart(2,'0')].join('-')) : '');
  function matches(c) {
