...
async function refreshGroupAttendanceV6951(preserveIds){
  ...
  if(!lop){if(panel)panel.classList.add('d-none');groupRosterV6951=[];groupAbsentIdsV6951.clear();groupRosterKeyV6951='';groupRosterModeV701='';if(countEl)countEl.value='0';if(nameEl)nameEl.value='';return;}
