...
function initV694Ui(){
  const matrixAllowed=v694Roles().some(r=>['TTCM','BGH','ADMIN'].includes(r)),matrixNav=document.getElementById('khbd-matrix-nav-v694');if(matrixNav)matrixNav.classList.toggle('d-none',!matrixAllowed);if(matrixAllowed)loadKhbdMatrixScopesV694(false);
